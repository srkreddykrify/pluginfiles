 ...
 */
public abstract class ExoPlayerWrapper
        ...
        MediaPlayer.OnVideoSizeChangedListener
{
    ...
    protected ExoPlayerWrapper(MediaPlayer mediaPlayer) {
        TAG = "" + this;
            ...
            switch (mState.get()) {
                ...
                case INITIALIZED:
                    try {
                        ...
                        /** we should not call {@link ExoPlayerWrapper#prepare()} in wrong state so we fall here*/
