...
public class TrimVideo {
    ...
    public static final String TRIM_VIDEO_OPTION = "trim_video_option",
            TRIM_VIDEO_URI = "trim_video_uri",TRIMMED_VIDEO_PATH="trimmed_video_path" ,CROP_RATIO ="CROP_RATIO" ,IS_CROPPED ="isCropAppiled" ;


    public static ActivityBuilder activity(String uri) {
        Log.d(TAG, "activity() called with: uri = [" + uri + "]");
        return new ActivityBuilder(uri);
    }

      public static ActivityBuilder activity(String uri,String cropRatio,Boolean status) {
        Log.d(TAG, "activity() called with: uri = [" + uri + "]");
        return new ActivityBuilder(uri,cropRatio,status);
    }
    ...
    public static final class ActivityBuilder {
     ...
     public ActivityBuilder(@Nullable String videoUri,@Nullable String ratio,@Nullable Boolean isCropped ) {
            this.videoUri = videoUri;
            this.ratio = ratio;
        ...
        private Intent getIntent(Activity activity) {
            ...
            intent.putExtra(CROP_RATIO,ratio);
