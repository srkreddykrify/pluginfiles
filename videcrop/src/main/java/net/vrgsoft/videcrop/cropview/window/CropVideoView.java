...
public class CropVideoView extends FrameLayout {
    ...
    public void showCrop(boolean value)
    {
        if(value)
        {
            mCropView.setVisibility(VISIBLE);
        }else {
            mCropView.setVisibility(GONE);
        }
    }
    protected void onSizeChanged(int newWidth, int newHeight, int oldw, int oldh) {
        Log.d(TAG, "onSizeChanged() called with: newWidth = [" + newWidth + "], newHeight = [" + newHeight + "], oldw = [" + oldw + "], oldh = [" + oldh + "]");
        ...
        Log.d(TAG, "onSizeChanged() called with:  lp.height = [" +  lp.height + "]," +
                " lp.width = [" + lp.width + "]");
        setLayoutParams(lp);
    ...
    public void setcentercrop()
    {
        ...
        VideoPlayer  mVideoPlayer = new VideoPlayer(getContext());
...
//        mPlayerView.setResizeMode(AspectRatioFrameLayout.RESIZE_MODE_ZOOM);
    ...
    public void initBounds(int videoWidth, int videoHeight, int rotationDegrees) {
        Log.d(TAG, "initBounds() called with: videoWidth = [" + videoWidth + "], videoHeight = [" + videoHeight + "], rotationDegrees = [" + rotationDegrees + "]");
